...
angular.module('myApp.controllers', ['myApp.i18n', 'LocalStorageModule', 'ui.utils', 'ngAnimate', 'toastr'])
  ...
  .controller('AppImSendController', function ($scope, $timeout, $rootScope, _, MtpApiManager, Storage, AppProfileManager, AppChatsManager, AppUsersManager, AppPeersManager, AppDocsManager, AppMessagesManager, AppInlineBotsManager, MtpApiFileManager, RichTextProcessor, TemplatesService, ToastService) {
