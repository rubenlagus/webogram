...
angular.module('myApp.directives', ['myApp.filters'])
  ...
  .directive('mySendForm', function (_, $q, $timeout, $compile, $modalStack, $http, $interpolate, Storage, AppStickersManager, AppDocsManager, ErrorService, AppInlineBotsManager, FileManager, shouldFocusOnInteraction, TemplatesService) {
    return {
      link: link,
      scope: {
        draftMessage: '=',
    ...
    function link ($scope, element, attrs) {
      ...
      var stickerImageCompiled = $compile('<a class="composer_sticker_btn" data-sticker="{{::document.id}}" my-load-sticker enable-direct-load="true" document="document" thumb="true" img-class="composer_sticker_image"></a>');
